...
/**
 * =========================================================================
 * TASK 3 TESTS: Comment on the image
 * =========================================================================
 */
@SpringBootTest
...
class CommentControllerTest {
    ...
    // TODO (Task 3 - tests): POST /api/images/{id}/comments with a valid
    ...
    // TODO (Task 3 - tests): POST with a blank/too-long comment returns 400.
    @Test
    void addComment_withInvalidText_returnsBadRequest() {
        // TODO: implement
    }

    // TODO (Task 3 - tests): GET /api/images/{id}/comments returns
